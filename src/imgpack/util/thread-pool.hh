...
namespace ImgPack
{
    namespace Util
    {
        ...
        public:
            ...
            // Reimplemented std::async which takes a callable (with no
            // arguments, so bind() or a lambda should be used to pass
            // arguments), and a dispatcher which is called when the value in
            // the std::future is ready
            template <typename T>
